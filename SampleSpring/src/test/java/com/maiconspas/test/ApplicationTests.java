...
public class ApplicationTests {
	 ...
	 private MediaType contentType = new MediaType(MediaType.APPLICATION_JSON.getType(),
	    ...
	    @Test
	    public void listUsersWithoutAuthenticationTest() throws Exception {
	    ...
	    public String obtainAccessToken() throws Exception {
	        ...
	        ResultActions result 
	          = mockMvc.perform(post("/oauth/token")
	            .params(params)
	            .with(httpBasic("sampleId","sampleSecret"))
	    ...
	    @Test
	    public void listUsersWithAuthenticationTest() throws Exception {
	    ...
	    @Test
	    public void listUsersWithWrongAuthenticationTest() throws Exception {
	    	String accessToken = obtainAccessToken();
	        mockMvc.perform(get("/adminUsers")
	        		.header("Authorization", "Bearer " + accessToken)
        	        .accept("application/json;charset=UTF-8"))
